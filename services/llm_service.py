...
def get_ai_completion(properties, skeleton_stars, candidate_stars, recommended_pairs, num_connections):
    ...
    LIGAÇÕES GEOMETRICAMENTE PRÓXIMAS RECOMENDADAS (Usa estas recomendações para proferir ligações, pois representam estrelas próximas que formam caminhos visualmente contínuos e sem cruzamentos):
